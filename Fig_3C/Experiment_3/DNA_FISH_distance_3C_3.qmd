...
light_levs <- c("OptoLoop-Dark","OptoLoop-Light","LADL-Dark","LADL-Light") 

plate_layout <- tibble(
  row = c(8L, 8L, 9L, 9L),
  column = c(5L, 19L,5L, 19L),
  well_index = c("H5", "H19","I5", "I19"),
  light = c("OptoLoop-Dark","OptoLoop-Light","LADL-Dark","LADL-Light")
) %>%
...
#| label: filter-spots
#| 
spot_filt_criterion <- quote(n_spots_channel_2 > 1 & n_spots_channel_4 >= n_spots_channel_2) #set criterion for filtering
