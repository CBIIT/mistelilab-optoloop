...
light_levs <- c("RNA-Dark","RNA-Light") 

plate_layout <- tibble(
  row = c(8L, 8L),
  column = c(6L, 20L),
  well_index = c("H6", "H20"),
  light = c("RNA-Dark","RNA-Light")
) %>%
...
#| label: filter-spots
#| 
spot_filt_criterion <- quote(n_spots_channel_3 == 4 & n_spots_channel_2 >= n_spots_channel_3) #set criterion for filtering
