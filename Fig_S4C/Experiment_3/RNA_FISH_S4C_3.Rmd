...
light_levs <- c("Ctrl_1","Ctrl_2","Ctrl_3","Ctrl_Light_1","Ctrl_Light_2","Ctrl_Light_3","sgSubtel+TERT_1","sgSubtel+TERT_2","sgSubtel+TERT_3","sgSubtel+TERT_Light_1","sgSubtel+TERT_Light_2","sgSubtel+TERT_Light_3") 

plate_layout <- tibble(
  row = c(7L,7L,7L,7L,7L,7L,9L,9L,9L,9L,9L,9L),
  column = c(5L,6L,7L,18L,19L,20L,5L,6L,7L,18L,19L,20L),
  well_index = c("G5","G6","G7","G18","G19","G20","I5","I6","I7","I18","I19","I20"),
  light = c("Ctrl_1","Ctrl_2","Ctrl_3","Ctrl_Light_1","Ctrl_Light_2","Ctrl_Light_3","sgSubtel+TERT_1","sgSubtel+TERT_2","sgSubtel+TERT_3","sgSubtel+TERT_Light_1","sgSubtel+TERT_Light_2","sgSubtel+TERT_Light_3") 
) %>%
