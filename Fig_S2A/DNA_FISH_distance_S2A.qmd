...
light_levs <- c("WT-Low-Dark","WT-Low-Light","WT-High-Dark","WT-High-Light","Olig-Low-Dark","Olig-Low-Light","Olig-High-Dark","Olig-High-Light") 

plate_layout <- tibble(
  row = c(8L, 8L, 8L, 8L, 9L, 9L, 9L, 9L),
  column = c(5L, 6L, 19L, 20L, 5L, 6L, 19L, 20L),
  well_index = c("H5", "H6", "H19", "H20", "I5", "I6", "I19", "I20"),
  light = c("WT-Low-Dark","WT-High-Dark","WT-Low-Light","WT-High-Light","Olig-Low-Dark", "Olig-High-Dark","Olig-Low-Light", "Olig-High-Light")
) %>%
...
#| label: filter-spots
#| 
spot_filt_criterion <- quote(n_spots_channel_4 > 1 & n_spots_channel_2 == n_spots_channel_4) #set criterion for filtering
