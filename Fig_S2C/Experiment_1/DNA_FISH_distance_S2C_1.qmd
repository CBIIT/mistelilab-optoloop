...
light_levs <- c("c3-Dark","c3-Light","c7-Dark","c7-Light","c15-Dark","c15-Light") 

plate_layout <- tibble(
  row = c(8L,8L,9L, 9L,10L,10L),
  column = c(5L, 19L,5L, 19L,5L, 19L),
  well_index = c("H5", "H19","I5", "I19","J5", "J19"),
  light = c("c3-Dark","c3-Light","c7-Dark","c7-Light","c15-Dark","c15-Light")
) %>%
...
cell_filter_tbl <- cell_tbl %>%
  filter(area >= 110, solidity >= 0.875)
```
